# testMTZA Message Extension Bot - `testMtzaMessageExtensionBot`
...
3. Give the bot a handle (ex: `testMtzaMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://testmtza.azurewebsites.net/api/messages`
